...
{
int a=1; b=2; c=3: ← as declarações das variaveis b e c estão erradas, visto que depois do ; o int não continua valendo para b e c. Além disso, a variável c se estivesse com seu tipo declardo corretamente, ainda sim não funcionaria pois deveria ter ; invés do uso do :.
